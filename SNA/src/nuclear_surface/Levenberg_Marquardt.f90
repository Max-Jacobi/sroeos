...
!
MODULE Levenberg_Marquardt_Mod
...
!      In this case set iflag to a negative INTEGER(I4B).

!    m is a positive INTEGER(I4B) input variable set to the number of functions.

!    n is a positive INTEGER(I4B) input variable set to the number of variables.
!      n must not exceed m.
...
!    info is an INTEGER(I4B) output variable.  If the user has terminated execution,
...
!    iwa is an INTEGER(I4B) work array of length n.

!    wa is a work array of length lwa.

!    lwa is a positive INTEGER(I4B) input variable not less than m*n+5*n+m.
...
!  **********
INTEGER(I4B)   :: maxfev, mode, nfev, nprint
...
!    maxfev is a positive INTEGER(I4B) input variable.  Termination occurs when the
...
!    mode is an INTEGER(I4B) input variable.  If mode = 1, the variables will be
...
!    nprint is an INTEGER(I4B) input variable that enables controlled printing of
...
!    info is an INTEGER(I4B) output variable.  If the user has terminated
...
!    nfev is an INTEGER(I4B) output variable set to the number of calls to fcn.
...
!    ldfjac is a positive INTEGER(I4B) input variable not less than m
!      which specifies the leading dimension of the array fjac.

!    ipvt is an INTEGER(I4B) output array of length n.  ipvt defines a permutation
...
REAL (DP), INTENT(IN)      :: tol
INTEGER(I4B), INTENT(OUT)       :: info
INTEGER(I4B), INTENT(IN OUT)    :: ipvt(:)
...
!    n is a positive INTEGER(I4B) input variable set to the number
...
!    ipvt is an INTEGER(I4B) output array of length n. ipvt
...
!    lwa is a positive INTEGER(I4B) input variable not less than 5*n+m.
...
!  **********
INTEGER(I4B)   :: maxfev, mode, nfev, njev, nprint
...
!    m is a positive INTEGER(I4B) input variable set to the number
!      of functions.
...
!    maxfev is a positive INTEGER(I4B) input variable.  Termination occurs when
...
!    mode is an INTEGER(I4B) input variable.  if mode = 1, the
...
!    nprint is an INTEGER(I4B) input variable that enables controlled printing
...
!    nfev is an INTEGER(I4B) output variable set to the number of
!      calls to fcn with iflag = 1.

!    njev is an INTEGER(I4B) output variable set to the number of
...
!    n is a positive INTEGER(I4B) input variable set to the order of r.
...
!    ldr is a positive INTEGER(I4B) input variable not less than n
!      which specifies the leading dimension of the array r.

!    ipvt is an INTEGER(I4B) input array of length n which defines the
...
!  **********
INTEGER(I4B)   :: iter, j, jm1, jp1, k, l, nsing
...
!    m is a positive INTEGER(I4B) input variable set to the number of rows of a.

!    n is a positive INTEGER(I4B) input variable set to the number of columns of a.
...
!    lda is a positive INTEGER(I4B) input variable not less than m
...
!    ipvt is an INTEGER(I4B) output array of length lipvt.  ipvt
!      defines the permutation matrix p such that a*p = q*r.
!      Column j of p is column ipvt(j) of the identity matrix.
!      If pivot is false, ipvt is not referenced.

!    lipvt is a positive INTEGER(I4B) input variable.  If pivot is false,
...
!  **********
INTEGER(I4B)   :: i, j, jp1, k, kmax, minmn
...
!    n is a positive INTEGER(I4B) input variable.
...
!    iflag is an INTEGER(I4B) variable which can be used to terminate
...
END MODULE Levenberg_Marquardt_Mod
