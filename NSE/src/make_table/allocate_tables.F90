...
!    allocate dx/dy, mu_n, mu_p, mu_hat, A, Z, xn, xp, xa, xh, u, r
    ...
    allocate(xl_tab(n_log10n,n_log10T,n_Yp))

    allocate(ah_tab(n_log10n,n_log10T,n_Yp))
    allocate(zh_tab(n_log10n,n_log10T,n_Yp))
    allocate(al_tab(n_log10n,n_log10T,n_Yp))
    allocate(zl_tab(n_log10n,n_log10T,n_Yp))
